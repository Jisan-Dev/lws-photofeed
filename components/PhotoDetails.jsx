...
const PhotoDetails = async ({ id, lang }) => {
  ...
  return (
    <div className="grid grid-cols-12 gap-4 2xl:gap-10 ">
      <div className="col-span-12 lg:col-span-8 border rounded-xl bg-teal-950/10">
        <Image
          className="max-w-full h-full max-h-[75vh] mx-auto object-contain"
          src={photo.url}
          alt={photo.title}
          width={900}
          height={900}
        ...
        <div className="mt-6">
          <div className="flex justify-between items-center mb-3">
            ...
            <button className="flex items-center gap-1.5 text-black/60 text-xs xl:text-sm">
              <Image src="/follow.svg" alt="follow" width={20} height={20} className="w-5 h-5" />
              {dictionary.follow}
            </button>
          </div>
        ...
        <div className="mt-6">
          <div className="flex items-stretch gap-3">
            <button className="flex-1 border py-1.5 rounded text-xs lg:text-sm flex items-center justify-center text-center gap-1.5 font-bold hover:bg-yellow-400">
              <Image src="/heart.svg" alt="heart" className="w-5 h-5" width={50} height={50} />
              {photo.likes}
            </button>
            <button className="flex-1 border py-1.5 rounded text-xs lg:text-sm flex items-center justify-center text-center gap-1.5 font-bold hover:bg-yellow-400">
              <Image src="/save.svg" alt="save" className="w-5 h-5" width={50} height={50} />
              {dictionary.save}
            </button>
            <button className="flex-1 border py-1.5 rounded text-xs lg:text-sm flex items-center justify-center text-center gap-1.5 font-bold hover:bg-yellow-400">
              <Image src="/share.svg" alt="share" className="w-5 h-5" width={50} height={50} />
              {dictionary.share}
            </button>
          </div>
        </div>
